...
class AppStrings {
  static const Map<AppLocale, Map<String, String>> _strings = {
    AppLocale.tradChinese: {
      ...
      'delete': '刪除',
      'delete_receipt': '刪除收據',
      'delete_receipt_confirm': '確定刪除這張收據？此操作無法撤銷。',
    ...
    AppLocale.english: {
      ...
      'delete_receipt_confirm': 'Are you sure you want to delete this receipt? This cannot be undone.',
    ...
    AppLocale.indonesian: {
      ...
      'delete_receipt_confirm': 'Apakah Anda yakin ingin menghapus resibo ini? Tindakan ini tidak dapat dibatalkan.',
    ...
    AppLocale.filipino: {
      ...
      'delete_receipt_confirm': 'Sigurado ka bang gusto mong burahin ang resibong ito? Hindi ito mababawi.',

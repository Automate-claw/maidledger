        ...
        children: [
          Expanded(
            child: Column(
              ...
              children: [
                Text(AppStrings.cashBalance(_locale), style: TextStyle(color: Colors.white70, fontSize: 13)),
                ...
                if (!_isPositiveBalance)
                  Text(AppStrings.overdraft(_locale), style: TextStyle(color: Colors.white60, fontSize: 12)),
              ],
            ),
          ),
          Column(
